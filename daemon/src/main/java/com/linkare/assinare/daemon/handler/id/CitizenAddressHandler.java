...
public class CitizenAddressHandler extends AssinareBaseDataHandler {

    private final AssinareId assinareId;

    public CitizenAddressHandler(final AssinareId assinareId) {
        this.assinareId = assinareId;
    }

    @Override
    protected JSONObject getData() throws AssinareError, AssinareException {
        return new JSONObject(assinareId.getCitizenAddress());
    }
}
